...
public class Binary {
	...
	static Log logger = LogFactory.getLog(Binary.class.getName());
	...
	public static void main(String args[]){
		...
		logger.debug("int i: " + x.i);
        logger.debug("int j: " + x.j);
        logger.debug("float f: " + x.f);
        logger.debug("double d: " + x.d);

		// Unpacking Array
        logger.debug("unapckA");
		Object[] oa;
		try {
