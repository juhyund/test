 ...
 * DHM Error codes
 */
#define PTLS_ERR_DHM_BAD_INPUT_DATA                    -0x3080  /**< Bad input parameters. */
#define PTLS_ERR_DHM_READ_PARAMS_FAILED                -0x3100  /**< Reading of the DHM parameters failed. */
#define PTLS_ERR_DHM_MAKE_PARAMS_FAILED                -0x3180  /**< Making of the DHM parameters failed. */
#define PTLS_ERR_DHM_READ_PUBLIC_FAILED                -0x3200  /**< Reading of the public values failed. */
#define PTLS_ERR_DHM_MAKE_PUBLIC_FAILED                -0x3280  /**< Making of the public value failed. */
#define PTLS_ERR_DHM_CALC_SECRET_FAILED                -0x3300  /**< Calculation of the DHM secret failed. */
#define PTLS_ERR_DHM_INVALID_FORMAT                    -0x3380  /**< The ASN.1 data is not formatted correctly. */
#define PTLS_ERR_DHM_ALLOC_FAILED                      -0x3400  /**< Allocation of memory failed. */
#define PTLS_ERR_DHM_FILE_IO_ERROR                     -0x3480  /**< Read or write of file failed. */
#define PTLS_ERR_DHM_HW_ACCEL_FAILED                   -0x3500  /**< DHM hardware accelerator failed. */
#define PTLS_ERR_DHM_SET_GROUP_FAILED                  -0x3580  /**< Setting the modulus and generator failed. */

#ifdef __cplusplus
extern "C" {
#endif

#if !defined(PTLS_DHM_ALT)

/**
 * \brief          The DHM context structure.
 */
typedef struct ptls_dhm_context
{
    size_t len;         /*!<  The size of \p P in Bytes. */
    ptls_mpi P;      /*!<  The prime modulus. */
    ptls_mpi G;      /*!<  The generator. */
    ptls_mpi X;      /*!<  Our secret value. */
    ptls_mpi GX;     /*!<  Our public key = \c G^X mod \c P. */
    ptls_mpi GY;     /*!<  The public key of the peer = \c G^Y mod \c P. */
    ptls_mpi K;      /*!<  The shared secret = \c G^(XY) mod \c P. */
    ptls_mpi RP;     /*!<  The cached value = \c R^2 mod \c P. */
    ptls_mpi Vi;     /*!<  The blinding value. */
    ptls_mpi Vf;     /*!<  The unblinding value. */
    ptls_mpi pX;     /*!<  The previous \c X. */
}
ptls_dhm_context;
 ...
 */
void ptls_dhm_init( ptls_dhm_context *ctx );
 ...
 * \return         An \c PTLS_ERR_DHM_XXX error code on failure.
 */
int ptls_dhm_read_params( ptls_dhm_context *ctx,
                     unsigned char **p,
 ...
 *                 space is available. Refer to \c ptls_mpi_size to computing
 *                 the byte-size of an MPI.
 *
 * \note           This function assumes that \c ctx->P and \c ctx->G
 *                 have already been properly set. For that, use
 *                 ptls_dhm_set_group() below in conjunction with
 *                 ptls_mpi_read_binary() and ptls_mpi_read_string().
 *
 * \param ctx      The DHM context.
 ...
 * \return         An \c PTLS_ERR_DHM_XXX error code on failure.
 */
int ptls_dhm_make_params( ptls_dhm_context *ctx, int x_size,
 ...
 *                 in preparation for ptls_dhm_make_params().
 *
 * \param ctx      The DHM context.
 ...
 * \return         An \c PTLS_ERR_DHM_XXX error code on failure.
 */
int ptls_dhm_set_group( ptls_dhm_context *ctx,
                           const ptls_mpi *P,
                           const ptls_mpi *G );
 ...
 * \return         An \c PTLS_ERR_DHM_XXX error code on failure.
 */
int ptls_dhm_read_public( ptls_dhm_context *ctx,
 ...
 * \return         An \c PTLS_ERR_DHM_XXX error code on failure.
 */
int ptls_dhm_make_public( ptls_dhm_context *ctx, int x_size,
                     unsigned char *output, size_t olen,
                     int (*f_rng)(void *, unsigned char *, size_t),
                     void *p_rng );
 ...
 * \return              An \c PTLS_ERR_DHM_XXX error code on failure.
 */
int ptls_dhm_calc_secret( ptls_dhm_context *ctx,
 ...
 */
void ptls_dhm_free( ptls_dhm_context *ctx );
 ...
 *
 * \return            \c 0 on success.
 * \return            An \c PTLS_ERR_DHM_XXX or \c PTLS_ERR_PEM_XXX error code
 *                    error code on failure.
 */
int ptls_dhm_parse_dhm( ptls_dhm_context *dhm, const unsigned char *dhmin,
                   size_t dhminlen );
 ...
 *                    error code on failure.
 */
int ptls_dhm_parse_dhmfile( ptls_dhm_context *dhm, const char *path );
#endif /* PTLS_FS_IO */
#endif /* PTLS_ASN1_PARSE_C */
 ...
 */
int ptls_dhm_self_test( int verbose );
 ...
 * through \c ptls_ssl_conf_dh_param.
 *
...
PTLS_DEPRECATED typedef char const * ptls_deprecated_constant_t;
#define PTLS_DEPRECATED_STRING_CONSTANT( VAL )       \
    ( (ptls_deprecated_constant_t) ( VAL ) )
#else
#define PTLS_DEPRECATED_STRING_CONSTANT( VAL ) VAL
 ...
 * IETF Standards</em>.
 */
#define PTLS_DHM_RFC5114_MODP_2048_P                         \
    PTLS_DEPRECATED_STRING_CONSTANT(                         \
 ...
 */
#define PTLS_DHM_RFC5114_MODP_2048_G                         \
    PTLS_DEPRECATED_STRING_CONSTANT(                         \
 ...
 *
 */
#define PTLS_DHM_RFC3526_MODP_2048_P                         \
    PTLS_DEPRECATED_STRING_CONSTANT(                         \
 ...
 * Diffie-Hellman groups for Internet Key Exchange (IKE)</em>.
 */
#define PTLS_DHM_RFC3526_MODP_2048_G                         \
    PTLS_DEPRECATED_STRING_CONSTANT( "02" )
 ...
 * Diffie-Hellman groups for Internet Key Exchange (IKE)</em>.
 */
#define PTLS_DHM_RFC3526_MODP_3072_P                         \
    PTLS_DEPRECATED_STRING_CONSTANT(                         \
        "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1"      \
        "29024E088A67CC74020BBEA63B139B22514A08798E3404DD"      \
        "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245"      \
 ...
 * Diffie-Hellman groups for Internet Key Exchange (IKE)</em>.
 */
#define PTLS_DHM_RFC3526_MODP_3072_G                      \
    PTLS_DEPRECATED_STRING_CONSTANT( "02" )
 ...
 * Diffie-Hellman groups for Internet Key Exchange (IKE)</em>.
 */
#define PTLS_DHM_RFC3526_MODP_4096_P                      \
    PTLS_DEPRECATED_STRING_CONSTANT(                      \
        "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1"   \
        "29024E088A67CC74020BBEA63B139B22514A08798E3404DD"   \
        "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245"   \
 ...
 * Diffie-Hellman groups for Internet Key Exchange (IKE)</em>.
 */
#define PTLS_DHM_RFC3526_MODP_4096_G                      \
    PTLS_DEPRECATED_STRING_CONSTANT( "02" )
...
#define PTLS_DHM_RFC3526_MODP_2048_P_BIN {        \
...
#define PTLS_DHM_RFC3526_MODP_2048_G_BIN { 0x02 }

#define PTLS_DHM_RFC3526_MODP_3072_P_BIN {       \
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
    0xC9, 0x0F, 0xDA, 0xA2, 0x21, 0x68, 0xC2, 0x34, \
    0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C, 0xD1, \
    0x29, 0x02, 0x4E, 0x08, 0x8A, 0x67, 0xCC, 0x74, \
...
#define PTLS_DHM_RFC3526_MODP_3072_G_BIN { 0x02 }

#define PTLS_DHM_RFC3526_MODP_4096_P_BIN  {       \
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,  \
    0xC9, 0x0F, 0xDA, 0xA2, 0x21, 0x68, 0xC2, 0x34,  \
    0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C, 0xD1,  \
    0x29, 0x02, 0x4E, 0x08, 0x8A, 0x67, 0xCC, 0x74,  \
...
#define PTLS_DHM_RFC3526_MODP_4096_G_BIN { 0x02 }

#define PTLS_DHM_RFC7919_FFDHE2048_P_BIN {        \
     0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
...
#define PTLS_DHM_RFC7919_FFDHE2048_G_BIN { 0x02 }

#define PTLS_DHM_RFC7919_FFDHE3072_P_BIN { \
     0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
     0xAD, 0xF8, 0x54, 0x58, 0xA2, 0xBB, 0x4A, 0x9A, \
     0xAF, 0xDC, 0x56, 0x20, 0x27, 0x3D, 0x3C, 0xF1, \
     0xD8, 0xB9, 0xC5, 0x83, 0xCE, 0x2D, 0x36, 0x95, \
...
#define PTLS_DHM_RFC7919_FFDHE3072_G_BIN { 0x02 }

#define PTLS_DHM_RFC7919_FFDHE4096_P_BIN {        \
     0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
     0xAD, 0xF8, 0x54, 0x58, 0xA2, 0xBB, 0x4A, 0x9A, \
     0xAF, 0xDC, 0x56, 0x20, 0x27, 0x3D, 0x3C, 0xF1, \
     0xD8, 0xB9, 0xC5, 0x83, 0xCE, 0x2D, 0x36, 0x95, \
...
#define PTLS_DHM_RFC7919_FFDHE4096_G_BIN { 0x02 }

#define PTLS_DHM_RFC7919_FFDHE6144_P_BIN {        \
     0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
     0xAD, 0xF8, 0x54, 0x58, 0xA2, 0xBB, 0x4A, 0x9A, \
     0xAF, 0xDC, 0x56, 0x20, 0x27, 0x3D, 0x3C, 0xF1, \
     0xD8, 0xB9, 0xC5, 0x83, 0xCE, 0x2D, 0x36, 0x95, \
...
#define PTLS_DHM_RFC7919_FFDHE6144_G_BIN { 0x02 }

#define PTLS_DHM_RFC7919_FFDHE8192_P_BIN {        \
     0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
     0xAD, 0xF8, 0x54, 0x58, 0xA2, 0xBB, 0x4A, 0x9A, \
     0xAF, 0xDC, 0x56, 0x20, 0x27, 0x3D, 0x3C, 0xF1, \
     0xD8, 0xB9, 0xC5, 0x83, 0xCE, 0x2D, 0x36, 0x95, \
...
#define PTLS_DHM_RFC7919_FFDHE8192_G_BIN { 0x02 }
