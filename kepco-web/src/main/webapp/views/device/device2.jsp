...
<link rel="stylesheet" type="text/css" href="<%=COMMON_PATH_JS%>/ext6.6/theme-neptune/resources/theme-neptune-all.css" />
<script>
var CONTEXT_PATH = "<%=COMMON_URL%>";
</script>
<script src="<%=COMMON_PATH_JS%>/inspinia.js"></script>
<script type="text/javascript" src="<%=COMMON_PATH_JS%>/ext6.6/ext-all.js"></script>
<script type="text/javascript" src="<%=COMMON_PATH_JS%>/common.js" charset="UTF-8"></script>
<script type="text/javascript" src="<%=COMMON_PATH_JS%>/extjs/device/DeviceInfoList.js"></script>
