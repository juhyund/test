...
function successCommunication(data, status) {
	...
	var t_rate = parseInt(t_cnt / data.total) * 100;
...
function successExcuteRate(data, status) {
    ...
    var last_tr = '<tr class="table-active">'
   	...
   	var exec_rate = Math.floor(succ_cnt / total_cnt) * 100;
   	
   	console.log("bb: " + succ_cnt);
   	console.log("aaa: " + exec_rate);
  
   	$("#exec_rate").html(exec_rate);
