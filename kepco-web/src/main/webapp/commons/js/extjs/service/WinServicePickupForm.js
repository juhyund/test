...
//팝업 window
var winServicePickupPop = function(service_no, delivery_no, cust_nm, insert_dt) {
	...
	if(winServicePickup.isVisible()) {
		...
		loadDataServicePickup(service_no, delivery_no, cust_nm, insert_dt);
 ...
 * @param service_no
 */
function loadDataServicePickup(service_no, delivery_no, cust_nm, insert_dt) {
