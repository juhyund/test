...
//팝업 window
var winServiceDeliveryPop = function(service_no, delivery_no, cust_nm, insert_dt) {
	...
	if(winServiceDelivery.isVisible()) {
		...
		loadDataServiceDelivery(service_no, delivery_no, cust_nm, insert_dt);
 ...
 * @param service_no
 */
function loadDataServiceDelivery(service_no, delivery_no, cust_nm, insert_dt) {
