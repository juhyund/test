...
Ext.onReady(function(){
    ...
    store = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: COMMON_URL + '/ajaxAgencyInfoList',
            reader: {
            	root: 'resultGrid',
    ...
    function popServiceArea() {
        ...
        if(agency_cd == "") {
        	Ext.Msg.alert('Notice', '찾서지역을 추가할 대리점을 먼저 선택해 주세요!');
        } else {
        	window.open(COMMON_URL+'/jsp/System/ServiceAgencyPop.jsp?agency_cd='+agency_cd+'&agency_nm='+agency_nm,'pop1','width=800, height=600');
        }
    }
    ...
    function popServiceArea2() {
        ...
        if(agency_cd == "") {
        	Ext.Msg.alert('Notice', '찾서지역을 조회할 대리점을 먼저 선택해 주세요!');
        } else {
        	window.open(COMMON_URL+'/jsp/System/ServiceAgencySearchPop.jsp?agency_cd='+agency_cd+'&agency_nm='+agency_nm,'pop2','width=800, height=600');
        }
    }
